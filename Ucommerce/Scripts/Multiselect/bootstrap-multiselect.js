    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return this.nonSelectedText + ' <b class="caret"><select /></b>';
                }
                else if (options.length == $('option', $(select)).length) {
                    return this.allSelectedText + ' <b class="caret"><select /></b>';
                }
                else if (options.length > this.numberDisplayed) {
                    return options.length + ' ' + this.nSelectedText + ' <b class="caret"><select /></b>';
                }
                else {
                    var selected = '';
                    ...
                    return selected.substr(0, selected.length - 2) + ' <b class="caret"><select /></b>';
                }
            },
            /**
