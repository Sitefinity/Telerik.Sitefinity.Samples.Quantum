<%@ Control Language="C#" CodeBehind="StoresWrapper.ascx.cs" Inherits="Ucommerce.Web.Shell.Sitefinity.StoresWrapper" %>
...
<iframe id="UcommerceIFrame" src="/Ucommerce/Vue/catalogs.html#/stores" style="width: 100%; border: 0"></iframe>
