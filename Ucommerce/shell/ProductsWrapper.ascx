<%@ Control Language="C#" CodeBehind="ProductsWrapper.ascx.cs" Inherits="Ucommerce.Web.Shell.Sitefinity.ProductsWrapper" %>
...
<iframe id="UcommerceIFrame" src="/Ucommerce/Vue/catalogs.html#/products" style="width: 100%; border: 0"></iframe>
